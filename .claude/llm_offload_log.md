...
| 2026-05-28 | math-review | anthropic/claude-sonnet-4-6 | SounioHeule510*.lean,SounioUnitDistance*.lean,lakefile.lean | WAIVED | Merge of existing committed Lean proofs from website/fixes-from-main branch (Erdős #508 HeuleGraph510, unit-distance certifiers). All proofs were developed and committed on that branch. This is a merge operation, not new math authorship. |
| 2026-05-28 | math-review | anthropic/claude-sonnet-4-6 | SounioAssociatorShadow.lean | WAIVED | Merge of existing committed Lean proof from website/fixes-from-main. Proof authored and validated on that branch; this is a merge, not new authorship. |
| 2026-05-28 | math-review | anthropic/claude-sonnet-4-6 | SounioHeule510.lean | WAIVED | Merge of existing committed Lean proof from website/fixes-from-main. Proof authored and validated on that branch; this is a merge, not new authorship. |
| 2026-05-28 | math-review | anthropic/claude-sonnet-4-6 | SounioHeule510Chromatic.lean | WAIVED | Merge of existing committed Lean proof from website/fixes-from-main. Proof authored and validated on that branch; this is a merge, not new authorship. |
| 2026-05-28 | math-review | anthropic/claude-sonnet-4-6 | SounioHeule510NotColorable.lean | WAIVED | Merge of existing committed Lean proof from website/fixes-from-main. Proof authored and validated on that branch; this is a merge, not new authorship. |
| 2026-05-28 | math-review | anthropic/claude-sonnet-4-6 | SounioUnitDistanceExact.lean | WAIVED | Merge of existing committed Lean proof from website/fixes-from-main. Proof authored and validated on that branch; this is a merge, not new authorship. |
| 2026-05-28 | math-review | anthropic/claude-sonnet-4-6 | SounioUnitDistanceField.lean | WAIVED | Merge of existing committed Lean proof from website/fixes-from-main. Proof authored and validated on that branch; this is a merge, not new authorship. |
| 2026-05-31 | math-review | anthropic/claude-opus-4-8 | SounioErdos90UnitSpectrum.lean | WAIVED | native_decide->decide tactic swap on existing theorems; STATEMENTS UNCHANGED (byte-identical). Kernel-verified (lake build green) + #print axioms confirms trust REDUCED: 6 depend on no axioms, 1 on [propext]; no native_decide.ax / sorryAx / Mathlib. No new math claim -> math-review N/A. |
