...
echo "=== SAN Large Architecture — ResNet-50 on CIFAR-10 ==="
...
export SAN_LARGE_ONLY=resnet50
export SAN_LARGE_DATASET=cifar10
export SAN_LARGE_THREADS=16
export SAN_LARGE_TAU_RESNET=0.35
export SAN_LARGE_DELTA_RESNET=0.50
...
python3 scripts/research/suffering_aware_large_architecture.py 2>&1 | \
  tee "${OUT_DIR}/resnet50_${SLURM_JOB_ID}.log"
