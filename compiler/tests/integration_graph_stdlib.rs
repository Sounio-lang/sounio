...
fn test_coherence_module_has_declaration() {
    ...
    let content = std::fs::read_to_string(&coherence_path)
        .expect("read coherence.sio");
...
fn test_nulls_module_structure() {
    ...
    let content = std::fs::read_to_string(&nulls_mod)
        .expect("read nulls/mod.sio");
...
fn test_curvature_demo_fixed() {
    ...
    let content = std::fs::read_to_string(&demo_path)
        .expect("read curvature_demo.sio");
