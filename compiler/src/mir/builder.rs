...
impl FunctionBuilder {
    ...
    pub fn build_store(&mut self, address: ValueId, value: ValueId) {
        let instruction = MirInstruction::Store {
            address,
            value,
        };
        self.build_instruction(instruction);
    ...
    pub fn build_gep(&mut self, result: ValueId, base: ValueId, indices: Vec<ValueId>, ty: MirType) {
    ...
    pub fn build_alloca(&mut self, result: ValueId, ty: MirType) {
        let instruction = MirInstruction::Alloca {
            result,
            ty,
        };
        self.build_instruction(instruction);
    ...
    pub fn build_cast(&mut self, result: ValueId, source: ValueId, source_ty: MirType, target_ty: MirType) {
    ...
    pub fn build_binary(&mut self, result: ValueId, op: MirBinaryOp, left: ValueId, right: ValueId, ty: MirType) {
    ...
    pub fn build_compare(&mut self, result: ValueId, op: MirCompareOp, left: ValueId, right: ValueId, ty: MirType) {
    ...
    pub fn build_call(&mut self, result: Option<ValueId>, func_name: String, args: Vec<ValueId>, ty: MirType) {
    ...
    pub fn build_call_indirect(&mut self, result: Option<ValueId>, func_ptr: ValueId, args: Vec<ValueId>, ty: MirType) {
    ...
    pub fn build_null(&mut self) -> ValueId {
        let result = self.fresh_value();
        self.build_const(result, MirConstant::Null, MirType::Ptr(Box::new(MirType::Void)));
        result
    }
    ...
    pub fn build_function_ref(&mut self, name: String) -> ValueId {
        let result = self.fresh_value();
        self.build_const(result, MirConstant::FunctionRef(name), MirType::Ptr(Box::new(MirType::Void)));
        result
    }
    ...
    pub fn build_select(&mut self, result: ValueId, condition: ValueId, true_value: ValueId, false_value: ValueId, ty: MirType) {
    ...
    /// Build a zero extend
    pub fn build_zext(&mut self, result: ValueId, source: ValueId, source_ty: MirType, target_ty: MirType) {
    ...
    /// Build a sign extend
    pub fn build_sext(&mut self, result: ValueId, source: ValueId, source_ty: MirType, target_ty: MirType) {
    ...
    /// Build a truncate
    pub fn build_trunc(&mut self, result: ValueId, source: ValueId, source_ty: MirType, target_ty: MirType) {
    ...
    pub fn build_ptrcast(&mut self, result: ValueId, source: ValueId, source_ty: MirType, target_ty: MirType) {
    ...
    pub fn build_cond_branch(&mut self, condition: ValueId, true_target: BlockId, false_target: BlockId) {
    ...
    pub fn build_switch(&mut self, value: ValueId, default_target: BlockId, cases: Vec<(i64, BlockId)>) {
...
impl ModuleBuilder {
    ...
    pub fn create_global(&mut self, name: String, ty: MirType, init: Option<MirConstant>, is_const: bool) -> ValueId {
