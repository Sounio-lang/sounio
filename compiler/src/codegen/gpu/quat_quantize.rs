...
pub fn quat_mul_i8_int32(
    ...
    // Compute in INT32
    let w_i32 = q1_i32[0] * q2_i32[0] - q1_i32[1] * q2_i32[1]
        - q1_i32[2] * q2_i32[2]
        - q1_i32[3] * q2_i32[3];
    let x_i32 = q1_i32[0] * q2_i32[1] + q1_i32[1] * q2_i32[0]
        + q1_i32[2] * q2_i32[3]
        - q1_i32[3] * q2_i32[2];
    let y_i32 = q1_i32[0] * q2_i32[2] - q1_i32[1] * q2_i32[3]
        + q1_i32[2] * q2_i32[0]
        + q1_i32[3] * q2_i32[1];
    let z_i32 = q1_i32[0] * q2_i32[3] + q1_i32[1] * q2_i32[2]
        - q1_i32[2] * q2_i32[1]
        + q1_i32[3] * q2_i32[0];
...
pub fn quat_mul_i8_dp4a_layout(q1_i8: [i8; 4], q2_i8: [i8; 4]) -> (i32, i32, i32, i32) {
    ...
    // y = w1*y2 - x1*z2 + y1*w2 + z1*x2
    let y = (q1_i8[0] as i32) * (q2_i8[2] as i32)
        - (q1_i8[1] as i32) * (q2_i8[3] as i32)
        + (q1_i8[2] as i32) * (q2_i8[0] as i32)
        + (q1_i8[3] as i32) * (q2_i8[1] as i32);

    // z = w1*z2 + x1*y2 - y1*x2 + z1*w2
    let z = (q1_i8[0] as i32) * (q2_i8[3] as i32)
        + (q1_i8[1] as i32) * (q2_i8[2] as i32)
