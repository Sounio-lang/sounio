...
- Molecule slots keep their `MoleculeViz` payload and a primitive atom/bond mirror for Canvas, audit, and HTML/SVG renderers. The mirror preserves atom and bond pixels across module boundaries while the Sounio-owned molecule remains the semantic source.
