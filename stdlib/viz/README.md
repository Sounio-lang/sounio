...
- `VizWorkbenchProjectWorkspace` keeps two complete Visual Project Format slots for A/B scientific scene work. Save/load/compare update active slot, comparison slot, deterministic diff hash, time metadata, and visible audit metadata while the project envelopes remain Sounio data.
