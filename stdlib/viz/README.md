...
- `VizWorkbenchExperimentPacketLedger` sequences those shareable packets as fixed-capacity Sounio evidence, storing packet/payload/frame/audit hashes plus consecutive deltas and passive HTML/SVG ledger metadata.
