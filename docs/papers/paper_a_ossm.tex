...
The $4.5\times$ per-step overhead is modest relative to the $9/11$ benchmark advantage (Table~\ref{tab:benchmarks}).
...
These results are verified computationally in Appendix~\ref{app:depth} and position O-SSM within a rich mathematical landscape inaccessible to associative architectures.
