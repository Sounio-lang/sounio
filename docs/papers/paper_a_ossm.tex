...
The S4D-Inv baseline uses the inverse-frequency initialization scheme that provides strong long-range memory in diagonal SSMs; O-SSM's advantage therefore cannot be attributed to poor initialization of the diagonal baseline.
