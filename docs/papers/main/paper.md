<!-- docs:meta
topic_id: repo.docs.papers.main.paper
authority: repo_only
audience: users
last_validated: 2026-03-07
validated_by: A2
source_of_truth: docs/governance/topic-registry.v1.json#repo.docs.papers.main.paper
-->
...
Sounio is implemented as an open-source systems language and compiler focused on scientific workflows where traceability and uncertainty propagation are required. The core compilation pipeline (frontend, type system, IR passes, code generation) comprises approximately 319,000 lines of Rust; the full repository totals 700,000 lines including developer tooling (LSP, formatter, linter) and exploratory modules. A 43,000-line self-hosted bootstrap compiler and a 236,000-line scientific standard library are written in Sounio itself. The implementation includes native code generation and standard-library modules covering autodiff, pharmacometric modeling, numerical methods, and dimensional analysis.
