<!-- docs:meta
topic_id: repo.docs.papers.main.non-assoc-tree-fold-skeleton-2026-08-06
authority: repo_only
audience: users
last_validated: 2026-03-07
validated_by: A2
source_of_truth: docs/governance/topic-registry.v1.json#repo.docs.papers.main.non-assoc-tree-fold-skeleton-2026-08-06
-->
...
**Date:** 2026-08-06
**Status:** Skeleton — evidence complete, writing in progress. **2026-08-14 correction note:** the Dyck-1 synthetic numbers (§3.1) and the SedenTree-16 pseudoknot numbers (§4b) share root causes retracted in the later draft's audit — see `cayley_dickson_hierarchy_paper_2026-08-13.md` §9. The Rfam RNA and OctTree pseudoknot numbers in this file were independently re-checked and are sound.
