...
Across 12 self-hosted generations, confidence rises from 26\% to 100\%
...
\item \textbf{The bootstrapping protocol} (\S\ref{sec:bootstrap}):
  a 12-generation self-hosting experiment in which \lean (the \sounio
...
\centering
\caption{%
  Bootstrap convergence across 12 generations.
