...
| Combined zero-provenance (sedenion+eisa) | `validated research` (fail-closed) | `scripts/ci/madaros_zero_provenance_failclosed_gate.sh`; `docs/handoff/BLK-20260805-p0b-zero-provenance.md` | "Combined sedenion+eisa zero-provenance is classified fail-closed under stock Madaros (thin-link rc=12, no segfault) with lean_single oracle PASS. Not Madaros-green." |
