...
```text
Semantic-Lane-ID: issue901-module-binding-authority-20260802
Owner: codex
...
Claims-Forbidden: full ModuleGraph completion; type-alias and other unsupported import-category authority; alias/reexport semantics; pub(super)/pub(in) ancestry; tuple-variant grammar support; frontend/native parity; fixed-point bootstrap; scientific, physical, or clinical validity
