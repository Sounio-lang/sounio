<!-- docs:meta
topic_id: repo.docs.implementation.codex-claude-parallel-contract
authority: historical
audience: maintainers
last_validated: 2026-03-07
validated_by: A7
source_of_truth: docs/governance/topic-registry.v1.json#repo.docs.implementation.codex-claude-parallel-contract
-->
