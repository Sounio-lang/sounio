<!-- docs:meta
topic_id: repo.docs.internal.implementation.rustless-cutover
authority: repo_only
audience: users
last_validated: 2026-03-07
validated_by: A2
source_of_truth: docs/governance/topic-registry.v1.json#repo.docs.internal.implementation.rustless-cutover
-->
...
**File**: the repository has no dedicated serializer test file today — the
serializer itself is `self-hosted/ir/serialize.sio`. Add the round-trip test to
whichever suite you extend for the new opcode:
