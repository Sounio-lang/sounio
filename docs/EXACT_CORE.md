...
|---|---|
| **Madaros** (default `bin/souc`) | Same-format source arithmetic typechecks (V0-E.2). Casts/implicit still refused. Madaros-run softfloat lowering of ops and builtin `print_f128` remain deferred (V0-E.3). |
