<!-- docs:meta
topic_id: repo.docs.implementation.native-backend-sovereignty
authority: historical
audience: maintainers
last_validated: 2026-03-07
validated_by: A7
source_of_truth: docs/governance/topic-registry.v1.json#repo.docs.implementation.native-backend-sovereignty
-->
