...
- Exact decimal printing of a wide local is not implemented. KL-7 makes
  `print`, `print_int`, and `println` fail closed for wide arguments before ELF
  emission; tests that need output compare explicitly selected `i64` limbs.
