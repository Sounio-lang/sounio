<!-- docs:meta
topic_id: repo.docs.audit.known-limitations-history-2026-09
authority: repo_only
audience: users
last_validated: 2026-03-07
validated_by: A2
source_of_truth: docs/governance/topic-registry.v1.json#repo.docs.audit.known-limitations-history-2026-09
-->

# KNOWN_LIMITATIONS.md — historical narrative (snapshot 2026-09-11)

**Docs status:** archived narrative. This file is the verbatim body of
`docs/compiler/KNOWN_LIMITATIONS.md` as it stood at `origin/main`
`3868c1805` (V0-E.5.10 merged), immediately before that document was rewritten
as a short ledger of open items (KL-0, program "Acabar com KNOWN_LIMITATIONS").
Nothing below was edited; dates, SHAs and line numbers are as they were written
and may be stale. Use it to recover the reasoning behind a closed item; use the
ledger for what is still open, `docs/compiler/MATURITY.md` for the maturity
tiers and `docs/compiler/BOOTSTRAP_SEED.md` for the seed policy.
