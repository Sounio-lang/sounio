...
2. **Ord 2″ trained targets** — instrument is gated (`ORD2_INSTRUMENT_OK`); next is
   trained LSTM/S4 over hundreds of paths (protocol §3–5). Synthetic baselines only
   for now (`rupture-ord2-alignment_2026-07-25.md`).  
