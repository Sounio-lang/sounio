...
- **Números de run do probe (2026-07-21):** `[FILL]` de artefacto resolvidos a partir de `PROBE-RESULT-*.md` + harnesses; restam abertos: multi-seed $\Delta$/$p$ do ResMLP, painel multi-seed de init LSTM, depósito Zenodo. Ver `probe-preprint-draft.md` v0.2.
