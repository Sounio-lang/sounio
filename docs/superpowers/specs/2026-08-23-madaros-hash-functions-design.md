...
- **No HMAC.** A keyed-hash construction is straightforward to build on top of any of these once they exist, but nothing in this project's current roadmap needs it. Flagged as easy future work, not built now.
