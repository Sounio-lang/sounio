...
check_grep "src:bt_rewrite"       "bt_add_src\[bt_s1 as usize\].*OpAdd|ir_binop.*bt_add_src" "$OPT"
echo "--- Tests ---"
MAIN="self-hosted/compiler/main.sio"
check_grep "main:T614_fn"  "fn compiler_main_test_bt_add_chain_basic" "$MAIN"
check_grep "main:T616_fn"  "fn compiler_main_test_bt_add_chain_amount" "$MAIN"
