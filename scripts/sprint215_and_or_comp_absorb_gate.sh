#!/usr/bin/env bash
# sprint215_and_or_comp_absorb_gate.sh — Sprint 215: Block DY AND-OR complement absorption
set -eo pipefail
...
cg "src:dy_bnot"       "is_bnot\[dy_o[rl] as usize\]" "$O"
cg "src:dy_and"        "ir_binop.*dy_s[12].*OpBitAnd" "$O"
echo ""; echo "--- Tests ---"
