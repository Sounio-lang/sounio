...
cg "main:T728_fn" "fn compiler_main_test_cm_" "$M"
cg "main:T729_fn" "fn compiler_main_test_cm_and_comp_xor_comm" "$M"
cg "main:T730_fn" "fn compiler_main_test_cm_and_comp_xor_val\|fn compiler_main_test_cm_and_comp_xor_mask" "$M"
cg "main:T731_fn" "fn compiler_main_test_cm_no_fold_diff_base" "$M"
cg "main:T732_fn" "fn compiler_main_test_cm_no_fold_non_comp" "$M"
cg "main:T733_fn" "fn compiler_main_test_cm_no_fold_or_outer\|fn compiler_main_test_cm_no_fold_or_op" "$M"
