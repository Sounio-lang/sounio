#!/usr/bin/env bash
# sprint181_or_comp_xor_not_gate.sh — Sprint 181: Block CQ OR complement XOR to NOT
set -eo pipefail
...
cg "src:cq_fn" "fn compiler_main_test_cq_" "self-hosted/compiler/main.sio"
echo ""; echo "--- Tests ---"
M="self-hosted/compiler/main.sio"
cg "main:T752" "fn compiler_main_test_cq_" "$M"
cg "main:T753" "fn compiler_main_test_cq_" "$M"
cg "main:T754" "fn compiler_main_test_cq_" "$M"
cg "main:T755" "fn compiler_main_test_cq_" "$M"
cg "main:T756" "fn compiler_main_test_cq_" "$M"
cg "main:T757" "fn compiler_main_test_cq_" "$M"
