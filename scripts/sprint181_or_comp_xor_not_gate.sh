...
T755
T756
T757; do cg "main:${t}" "fn compiler_main_test_cq_" "$M"; done
cg "main:total" "let total: i64 = [0-9]+" "$M"
echo ""; echo "--- Self-tests ---"
L="$(mktemp)"
if [ ! -x "$SOUC" ]; then for t in T752
T753
T754
T755
T756
T757; do TOTAL=$((TOTAL+1)); echo "NOT_RUN  selftest:$t"; NOT_RUN=$((NOT_RUN+1)); done
...
T755
T756
T757; do cl "selftest:$t" "$t OK" "$L"; done; fi
rm -f "$L"
