...
echo 'sounio-loom-continuity-adapter-selftest: PASS language=Sounio engine=lean_single transport=stdin initial=accept clean=accept pod=accept predecessor=refused count=refused kind=refused canonical=refused sabotage_predecessor_guard=exposed'
