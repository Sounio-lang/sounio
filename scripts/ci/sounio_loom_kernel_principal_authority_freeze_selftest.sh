...
MANIFEST="$ROOT_DIR/tools/loom/kernel_principal_authority.freeze.v2"
EVIDENCE="$ROOT_DIR/tools/loom/evidence/loom-kernel-principal-authority-v2-20260916.txt"
...
[[ "$(field schema)" == loom-kernel-principal-authority-freeze-v2 ]] || fail 'unknown manifest schema'
