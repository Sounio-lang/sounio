...
verifier="$repo_root/scripts/research/cs6_section_resident_two_return_verify.py"
runner="$repo_root/scripts/research/cs6_section_resident_two_return_run.sh"
receipt="$repo_root/scripts/research/cs6_section_resident_two_return_receipt_v1.txt"
provenance="$repo_root/scripts/research/cs6_section_resident_two_return_provenance_v1.txt"
document="$repo_root/docs/research/cs6_section_resident_two_return_2026-07-31.md"
...
expected_paths = {
    "RECEIPT": "scripts/research/cs6_section_resident_two_return_receipt_v1.txt",
    "INPUT": "scripts/research/receipts/cs6_section_resident_two_return_input_v1.txt",
    "MANIFEST": "scripts/research/receipts/cs6_section_resident_two_return_run_manifest_v1.txt",
    "VERIFICATION": "scripts/research/receipts/cs6_section_resident_two_return_verification_v1.txt",
    "DEPENDENCIES": "scripts/research/receipts/cs6_section_resident_two_return_dependencies_v1.sha256",
    "LINK_INPUTS": "scripts/research/receipts/cs6_section_resident_two_return_link_inputs_v1.sha256",
    "RUNTIME_LIBRARIES": "scripts/research/receipts/cs6_section_resident_two_return_runtime_libraries_v1.sha256",
    "COMPILE_COMMAND": "scripts/research/receipts/cs6_section_resident_two_return_compile_command_v1.txt",
    "CAPD_CFLAGS": "scripts/research/receipts/cs6_section_resident_two_return_capd_cflags_v1.txt",
    "CAPD_LIBS": "scripts/research/receipts/cs6_section_resident_two_return_capd_libs_v1.txt",
    "CAPD_VERSION": "scripts/research/receipts/cs6_section_resident_two_return_capd_version_v1.txt",
    "PREPROCESSOR_MACROS": "scripts/research/receipts/cs6_section_resident_two_return_preprocessor_macros_v1.txt",
    "EFFECTIVE_OPTIONS": "scripts/research/receipts/cs6_section_resident_two_return_effective_options_v1.txt",
}
...
fixed_manifest = {
    "MANIFEST_KIND": "CS6_SECTION_RESIDENT_TWO_RETURN_V1",
...
expected_input = (
    "INPUT_SCHEMA=sounio.cs6.section-resident-two-return-input.v1\n"
    "SOURCE=N0\n"
    "U_INDEX=20000\n"
    "S_INDEX=15000\n"
    "U_TILES=40000\n"
...
required_verification = (
    "VERIFY_SCHEMA=sounio.cs6.section-resident-two-return-verification.v1",
    ...
    "P1_STATE_JOINT_OVERLAP=true", "P1_TIME_JOINT_OVERLAP=true",
    "P1_DP_JOINT_OVERLAP=true", "P2_STATE_JOINT_OVERLAP=true",
    "P2_TIME_JOINT_OVERLAP=true", "P2_DP_JOINT_OVERLAP=true",
    "P2_VELOCITY_JOINT_OVERLAP=true",
    "P2_DETERMINANT_JOINT_OVERLAP=true", "PROMOTION_ELIGIBLE=false",
)
...
grep -Fq 'INV-20260731-cs6-section-resident-two-return' "$document"
grep -Fq 'EXP_ELL_RECOMPUTED=true' "$document"
grep -Fq 'determinant intervals cross zero' "$document"

capd_config="${CS6_SECTION_RESIDENT_TWO_RETURN_CAPD_CONFIG:-${CAPD_CONFIG:-/tmp/capd-build/bin/capd-config}}"
[[ -x "$capd_config" ]] || {
...
printf 'CS6_SECTION_RESIDENT_TWO_RETURN_GATE_PASS=true\n'
