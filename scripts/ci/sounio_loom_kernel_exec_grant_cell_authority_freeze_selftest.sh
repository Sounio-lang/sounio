...
EVIDENCE="$ROOT_DIR/tools/loom/evidence/loom-kernel-exec-grant-cell-authority-v2-20260917.txt"
...
[[ "$(field schema)" == loom-kernel-exec-grant-cell-authority-freeze-v2 ]] || fail 'unknown manifest schema'
