...
MANIFEST="$ROOT_DIR/tools/loom/effect_closure_authority.freeze.v2"
EVIDENCE="$ROOT_DIR/tools/loom/evidence/loom-effect-closure-authority-v2-20260917.txt"
...
[[ "$(field schema)" == loom-effect-closure-authority-freeze-v2 ]] || fail 'unknown manifest schema'
