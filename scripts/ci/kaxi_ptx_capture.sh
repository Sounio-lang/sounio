...
PATTERNS=(
    exit_only
    vec_add vec_sub vec_mul vec_div vec_min vec_max vec_abs vec_neg vec_sqrt vec_recip vec_lg2 vec_ex2 vec_sin vec_cos vec_rsqrt vec_conf_sqrt vec_sqrt_gate_var fma
