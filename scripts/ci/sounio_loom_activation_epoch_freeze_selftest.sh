...
M="$ROOT/tools/loom/activation_epoch.freeze.v1"
...
expect schema loom-activation-epoch-freeze-v1
expect stage SEMANTICS_FROZEN
expect semantic_authority Sounio
expect action 9049
expect parent_freeze_sha256 0765d7e941a5def05e8ae7d08a90c7826491c86b4c1efc8679b40a6a728de29d
