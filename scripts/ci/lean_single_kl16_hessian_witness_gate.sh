#!/usr/bin/env bash
# KL-16a: pin lean_single Hessian Tier 1 + Tier 3 witnesses.
#
...
#
# Not pinned (OPEN — observed seed miss on lean_single):
#   Tier 2  tests/run-pass/epistemic_hessian_8inputs.sio
#           H[4,5] of a product prints 7.0 (analytic 1.0) even with * 0.0
#           keep-alive anchors on unused measures. Do not ratchet 7.0.
#
# Residual (also OPEN for KL-16b):
...
# eight_inputs intentionally omitted: H[4,5] still prints 7.0 on lean_single.
