...
EVIDENCE="$ROOT_DIR/tools/loom/evidence/loom-kernel-invocation-cell-authority-v3-20260917.txt"
...
[[ "$(field schema)" == loom-kernel-invocation-cell-authority-freeze-v3 ]] || fail 'unknown manifest schema'
