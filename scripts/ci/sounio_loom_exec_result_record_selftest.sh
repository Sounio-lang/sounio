...
13164c31635609daa3ac8e993be03ee293f48f95fa1552b91f245e4d02a81915
LOOM_EXEC_RESULT_RECORD/1|operation=sounio-check|event_sha256|command_template_sha256|generation_sha256|source_sha256|compiler_sha256|argv_sha256|artifact_sha256|artifact_bytes|stdout_sha256|stderr_sha256|diagnostics_sha256|sandbox_profile_sha256|principal_sha256|descriptor_binding_sha256|grant_receipt_sha256|exit_code
