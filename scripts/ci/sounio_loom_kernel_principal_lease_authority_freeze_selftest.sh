...
EVIDENCE="$ROOT_DIR/tools/loom/evidence/loom-kernel-principal-lease-authority-v2-20260916.txt"
...
[[ "$(field schema)" == loom-kernel-principal-lease-authority-freeze-v2 ]] || fail 'unknown manifest schema'
