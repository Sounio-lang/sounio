...
#     and additive inverses, so a low-limb-only implementation cannot pass.
# ---------------------------------------------------------------------------
...
pass "KL-7 sign-extension sabotage control fires"
...
echo "[wide-int] PASS: KL-7 fail-closed wide print + signed high-limb witnesses"
