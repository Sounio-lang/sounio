...
VERTICAL_MAIN_SHA256=1835bb5d14368c6c9c831ab87d45e4724e6dd8bef8ef9f3b93938ca74932b936
...
grep -Fq 'true_private_fn=E175 true_private_struct=E176 true_private_enum=E177 true_private_struct_variant=E177' "$VISIBILITY_LOG" || blocked visibility_854_private_controls_missing visibility_854 854
grep -Fq '[madaros-visibility-context] receipt issue=854 context_state=resolved runtime_state=pass ambiguous_global=E137 ambiguous_bare_variant=E137 aggregate_witness_mode=check-only duplicate_private_struct=pass duplicate_private_enum=pass variant_call_form=pass struct_variant=pass cross_kind=pass bare_variant=pass single_e175=0 matrix_e175=0 true_private_fn=E175 true_private_struct=E176 true_private_enum=E177 true_private_struct_variant=E177' "$VISIBILITY_LOG" || {
  cat "$VISIBILITY_LOG" >&2 || true
  blocked visibility_854_not_resolved_runtime_pass visibility_854 854
}

printf 'MODULE_GRAPH_FACADE_VERTICAL_RECEIPT status=pass raw_authority=explicit_sha256 raw_sha256=%s vertical_behavior=pass graph_identity=unproven full_ir_input_receipt=closure_order_matched lowering=executed lowering_identity_consumption=proven driver=canonical_full_ir legacy_compact=disabled phase_topology=closure_checker_count_full_ir_input_receipt_matched runtime_stdout=42_LF fixture_main_sha256=%s facade=selective negatives=3/3 missing_package=fail_closed missing_package_lowering_markers=absent fallback=none visibility_854=resolved visibility_854_ambiguous_global=E137 visibility_854_ambiguous_bare_variant=E137 visibility_854_aggregate_witness_mode=check-only visibility_854_duplicate_private_struct=pass visibility_854_duplicate_private_enum=pass visibility_854_variant_call_form=pass visibility_854_struct_variant=pass visibility_854_cross_kind=pass visibility_854_bare_variant=pass visibility_854_true_private_struct_variant=E177 issue_991_oracle=%s issue_991_head=%s\n' \
