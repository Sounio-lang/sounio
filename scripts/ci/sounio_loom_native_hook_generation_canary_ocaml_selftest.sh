...
write_decision() {
  ...
  printf '%b\n' \
    "schema=loom-agent-hook-receipt-v1\tdecision=ALLOW\tprovider=$provider\tevent=$event\tsemantics_sha256=842152d98a0222353d4432fc3549ce5df9730c73e1b319617cf340e75cf1d998\tsemantic_authority_language=Sounio\tsemantic_authority_role=SEMANTIC_AUTHORITY\ttoolchain_sha256=$loom_sha256\tprovider_config_sha256=$config_sha256\tresult=SOUNIO_NATIVE_HOOK_CUTOVER HOOK_EVENT_ADMIT semantic_authority=Sounio action=9045" \
    >> "$path"
}
