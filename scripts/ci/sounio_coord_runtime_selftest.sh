...
sed -i 's/SOUNIO_COORD_RUNTIME_VERSION=2026\.08\.23\.1/SOUNIO_COORD_RUNTIME_VERSION=2026.08.23.2-test/' \
...
grep -q '^runtime_version=2026.08.23.2-test$' <<< "$output" || fail 'upgraded runtime version is wrong'
