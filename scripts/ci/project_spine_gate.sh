...
echo "[project-spine] 1/12 public runner baseline"
bash scripts/ci/real_language_runner_gate.sh

echo "[project-spine] 2/12 checked example project"
...
echo "[project-spine] 3/12 souc init project loop"
...
echo "[project-spine] 4/12 missing import negative"
...
echo "[project-spine] 5/12 package import manifest gate"
bash scripts/ci/package_import_science_gate.sh

echo "[project-spine] 6/12 thin multimodule runtime"
...
echo "[project-spine] 7/12 Madaros identity and single-file native-v2"
...
echo "[project-spine] 8/12 Madaros source body semantics"
bash scripts/ci/madaros_source_semantics_gate.sh

echo "[project-spine] 9/12 Madaros project import runtime"
...
echo "[project-spine] 10/12 Madaros imported argument-call runtime"
set +e
...
echo "[project-spine] 11/12 native aggregate ABI"
bash scripts/ci/native_aggregate_abi_gate.sh

echo "[project-spine] 12/12 imported modular IR lowering gate"
