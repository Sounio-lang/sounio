...
echo "[project-spine] 1/10 public runner baseline"
bash scripts/ci/real_language_runner_gate.sh

echo "[project-spine] 2/10 checked example project"
...
echo "[project-spine] 3/10 souc init project loop"
...
echo "[project-spine] 4/10 missing import negative"
...
echo "[project-spine] 5/10 package import manifest gate"
bash scripts/ci/package_import_science_gate.sh

echo "[project-spine] 6/10 thin multimodule runtime"
...
echo "[project-spine] 7/10 Madaros identity and single-file native-v2"
...
echo "[project-spine] 8/10 Madaros project import runtime"
...
echo "[project-spine] 9/10 Madaros imported argument-call runtime"
set +e
