...
QUOTIENT_SHA256='6eec6e3286c30c45034ad34acec3f783026d86a94be7251ba8117c3e6e50910c'
...
BUILD_FRAME_SHA256='4847c8a246ada5d74b3d2d2d66672c191bcc2ce318b8c61869ff6aeb8f80af1d'
...
QUOTIENT_FRAME_SHA256='6ae7af09a9a6e6f34f808b566fac3e91873d0d8a47d3af5f7e0dcd7fc9ac2591'
...
require_line "${ROOT}/${QUOTIENT_REL}" '  , concreteCanonicalEqualityIffFullDeclaredOrbitProved := true'
...
grep -Fq 'ZAI_PROVIDER_ERROR_1313' "${ROOT}/${OFFLOAD_LOG_REL}" || fail 'Z.AI failure disclosure missing'
...
[[ "${python_processes_launched}" -eq 0 ]] || fail 'Python process launch drift'

printf 'PIREUS_CONCRETE_QUOTIENT_ACTION_GATE_PASS_PARTIAL=true stage=PARITY_OPEN language=Lean4 role=FORMAL_PARITY semantic_authority=Sounio source_commit=%s exact_bitvec_lex=true action_count_40320=true action_closure=true gauge_word_type=Fin_2_POW_11 gauge_word_count=2048 normalization_absorption=true quotient_action_laws=true full_declared_orbit_canonical_equality=true target03=true executed_sounio_streaming_equality=false formal_parity_complete=false computable_extraction_claim=false choice_free_core_claim=false guardian_role=PREEXECUTION_POLICY axiom_reports=71 axiom_free=3 propext=68 classical_choice=46 quot_sound=64 native_decide=0 sorryax=0 python_oracle=E110 python_process_launched=false guardian_current_gate_false_exit=1 spark_route=KUBERNETES_ONLY spark_nodes_used=false dgx_nodes_used=false slurm_processes_launched=0 u250_declared=2 u250_installed=1 u250_pending_installation=1 u250_enumeration_failures=0 llm_role=REVIEW_ONLY llm_confirmed_result=false zai=ERROR_1313 novelty_confirmed=false claim_ready=false\n' "${SOURCE_COMMIT}"
