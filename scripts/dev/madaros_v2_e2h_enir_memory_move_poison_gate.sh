...
BASE_REF="${E2H_BASE_REF:-origin/canon/madaros-v2-sota}"
...
git diff --quiet "$BASE_REF" -- \
  ...
  || fail "E2H changed codegen/ABI/runtime, pinned qd semantics, or frozen METRON oracle"
...
E2G_BASE_REF="$BASE_REF" bash scripts/dev/madaros_v2_e2g_enir_fuel_control_frail_gate.sh >"$TMP_DIR/e2g-regression.log"
