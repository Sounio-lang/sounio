...
git diff --quiet "$BASE_REF" HEAD -- self-hosted/compiler/main.sio self-hosted/ir self-hosted/native self-hosted/wasm self-hosted/gpu stdlib/runtime stdlib/eisa stdlib/math/dd64.sio stdlib/math/qd128.sio self-hosted/enir/qd.sio tools/eisa/eisa_evm_run.sio || fail "E2G changed codegen/ABI/runtime, pinned qd semantics, or frozen METRON oracle"
