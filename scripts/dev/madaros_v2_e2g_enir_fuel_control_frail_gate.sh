...
BASE_REF="${E2G_BASE_REF:-origin/canon/madaros-v2-sota}"
...
git diff --quiet "$BASE_REF" -- self-hosted/compiler/main.sio self-hosted/ir self-hosted/native self-hosted/wasm self-hosted/gpu stdlib/runtime stdlib/eisa stdlib/math/dd64.sio stdlib/math/qd128.sio self-hosted/enir/qd.sio tools/eisa/eisa_evm_run.sio || fail "E2G changed codegen/ABI/runtime, pinned qd semantics, or frozen METRON oracle"
...
E2F_BASE_REF="$BASE_REF" bash scripts/dev/madaros_v2_e2f_enir_rump_qd_gate.sh >"$TMP_DIR/e2f-regression.log"
