...
BASE_REF="${E2D_BASE_REF:-origin/canon/madaros-v2-sota}"
...
E2C_BASE_REF="$BASE_REF" bash scripts/dev/madaros_v2_e2c_enir_fuel_blockargs_gate.sh >"$TMP_DIR/e2c-regression.log"
