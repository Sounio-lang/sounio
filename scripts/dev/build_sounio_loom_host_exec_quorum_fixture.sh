...
printf 'BUILT_HOST_EXEC_QUORUM_FIXTURE path=%s language=Sounio role=SEMANTIC_FIXTURE_PRODUCER authority_manifest_sha256=a763255a922b95c5eb8855c85250f2f3e9db5f54889ea910250434b1df00e0f4 engine=%s fixtures=5\n' \
  "$OUTPUT" "$ENGINE"
