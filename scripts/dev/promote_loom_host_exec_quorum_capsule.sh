...
[[ "$host_output" == *'loom-product-exec-cell-host: PASS '* && \
   ...
   "$host_output" == *' raw_event_separate=true event_override=test-only+probe-only '* && \
