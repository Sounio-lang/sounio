...
OUTPUT_ROOT="${SOUNIO_LOOM_PROCESS_WITNESS_EFFECT_ROOT_V4_OUTPUT:-$ROOT_DIR/tools/loom/_build/effect-root-v4}"
CELL_BUILDER="$ROOT_DIR/scripts/dev/build_loom_process_witness_effect_policy_v4.sh"
...
fail() {
  printf 'build-loom-process-witness-effect-root-v4: FAIL reason=%s\n' "$*" >&2
  exit 1
}
...
[[ "$(sha256sum "$POLICY_MANIFEST" | cut -d ' ' -f 1)" == \
  ...
  fail 'frozen V4 policy manifest drifted'
...
SOUNIO_LOOM_PROCESS_WITNESS_EFFECT_POLICY_V4_OUTPUT="$OUTPUT_ROOT/loom/effect-cell" \
...
install -m 0444 "$POLICY_MANIFEST" "$OUTPUT_ROOT/loom/effect-policy-v4.freeze.v1"
...
loom/effect-policy-v4.freeze.v1:0444:60cff91db90e9214e62a6fa5b45521249e31649c63dce297683ca477fcd3d627
...
printf 'BUILT_LOOM_PROCESS_WITNESS_EFFECT_ROOT_V4 path=%s producer=C++20+Sounio role=MATERIAL_PARITY semantic_authority=Sounio action=9025 capsule=true cell_sha256=%s payload_sha256=%s policy_manifest_sha256=60cff91db90e9214e62a6fa5b45521249e31649c63dce297683ca477fcd3d627 payload_manifest_sha256=624ccd7297778803eff8d9972a33d5e55fb022f9e7e37f444f0aee13c22fb4da tree_sha256=%s static_cell=true static_payload=true systemd_mount=/run/systemd/incoming dev_null=host_materialization_required host_root_ownership=false root_read_only=false material_coverage=false complete_effects=false material_execution=false launch_open=false\n' \
