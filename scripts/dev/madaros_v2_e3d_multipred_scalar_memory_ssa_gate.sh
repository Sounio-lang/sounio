...
BASE_REF="${E3D_BASE_REF:-origin/canon/madaros-v2-sota}"
...
git diff --quiet "$BASE_REF" -- self-hosted/compiler/main.sio self-hosted/ir self-hosted/native self-hosted/wasm self-hosted/gpu stdlib/runtime stdlib/eisa stdlib/math/dd64.sio stdlib/math/qd128.sio self-hosted/enir/qd.sio self-hosted/enir/mir_cfg.sio tools/eisa/eisa_evm_run.sio \
  || fail "E3D changed production codegen/ABI/runtime, frozen E3C MIR, pinned qd semantics, or METRON oracle"
