...
BASE_REF="${E2E_BASE_REF:-origin/canon/madaros-v2-sota}"
...
git diff --quiet "$BASE_REF" -- \
  ...
  || fail "E2E changed compiler codegen/ABI/runtime, shared qd128, or the frozen METRON oracle"
...
E2D_BASE_REF="$BASE_REF" bash scripts/dev/madaros_v2_e2d_enir_rump_dd_gate.sh >"$TMP_DIR/e2d-regression.log"
