...
BASE_REF="${E2_BASE_REF:-origin/canon/madaros-v2-sota}"
...
git diff --quiet "$BASE_REF" -- \
  ...
  || fail "E2 changed a compiler codegen/ABI/runtime or EVM-oracle surface"
...
bash scripts/dev/madaros_v2_e1_enir_shadow_gate.sh >/dev/null
