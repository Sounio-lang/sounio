...
check_grep "src:cf_subset_check"  "cf_c1 & cf_c2.*== cf_c2" "$OPT_FILE"
echo ""
echo "--- Tests ---"
MAIN_FILE="self-hosted/compiler/main.sio"
check_grep "main:T686_fn" "fn compiler_main_test_cf_or_and" "$MAIN_FILE"
check_grep "main:T687_fn" "fn compiler_main_test_cf_or_and_superset" "$MAIN_FILE"
check_grep "main:T688_fn" "fn compiler_main_test_cf_or_and_comm" "$MAIN_FILE"
check_grep "main:T689_fn" "fn compiler_main_test_cf_no_fold" "$MAIN_FILE"
check_grep "main:T690_fn" "fn compiler_main_test_cf_no_fold_disjoint" "$MAIN_FILE"
check_grep "main:T691_fn" "fn compiler_main_test_cf_no_fold_rr" "$MAIN_FILE"
