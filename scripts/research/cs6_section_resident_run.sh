...
verifier_file="$repo_root/scripts/research/cs6_section_resident_verify.py"
runner_file="$repo_root/scripts/research/cs6_section_resident_run.sh"
...
{
  printf 'INPUT_SCHEMA=sounio.cs6.section-resident-input.v1\n'
  printf 'SOURCE=N0\n'
...
{
  printf 'MANIFEST_KIND=CS6_SECTION_RESIDENT_ONE_RETURN_V1\n'
