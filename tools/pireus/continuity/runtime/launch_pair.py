...
def main():
 ...
 for pod in selected:
  ...
  for name in ["patch_checkpoint_copy.py","qualify_checkpoint_copy.py","offline_generate.py","evict_checkpoint_cache.py","patch_marlin_deinterleave.py","profile_cuda_memory.py","tokenizer_transport.py","run_in_container.sh","qualify_tp2.py","inspect_runtime.py","profile_model_memory.py","qualify_marlin_placeholders.py","patch_marlin_placeholders.py","patch_marlin_repack.py","install_marlin_overlay.py","qualify_model.py","serve_rank.sh","memory_guard.py","worker_prerequisites.py","inkling-files.json"]:
