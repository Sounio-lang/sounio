...
def main():
 ...
 lock=json.loads((HERE/"recovery-serialization-lock.json").read_text())
 ...
 assert {k for k in old.keys()|new.keys() if old.get(k)!=new.get(k)}=={"host_fence_manifest_sha256","material_policy_sha256","admission_manifest_sha256","material_backend_sha256"}
