...
- The verified top-tier worktree is `/tmp/sounio-cc2-mcp` on
  `feature/mcp-server`. The primary `/workspace/sounio` checkout still contains
  unrelated dirty work and should not be used as the commit source for CC-2.
