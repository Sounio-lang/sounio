...
\begin{table}[h]
\centering
\caption{Fibre-signature separation (qualitative).  Four synthetic
...
\begin{table}[h]
\centering
\caption{Reconstruction residual (L${}^2$) averaged over 100 samples,
...
\begin{table}[h]
\centering
\caption{Three-axis comparison between AMI (168-basis) and SAE/transcoder
