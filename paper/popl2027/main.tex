...
We implement epistemic types in \sounio, a 377{,}000-line self-hosted systems
...
\begin{enumerate}
  ...
  \item An implementation in \sounio, a 377{,}000-line self-hosted systems programming
...
\texttt{SounioEffects}      & 637 & 87 & Effect rows, handler soundness \\
\texttt{SounioLinear}       & 459 & 64 & Four-modality lattice \\
\texttt{SounioTyping}       & 490 & 42 & Bidirectional typing judgment \\
\texttt{SounioSemantics}    & 293 & 27 & CBV operational semantics \\
...
\begin{itemize}
  ...
  \item \textbf{Four-modality linear lattice} (64 theorems):
...
and the substitution lemma respects modality constraints (64 theorems
...
algebra are proved in 87 theorems (\texttt{SounioEffects.lean}).
...
(64 theorems in \texttt{SounioUnits.lean}).
...
We implement epistemic types in \sounio, a self-hosted systems programming
language with a 105{,}000-line compiler and 272{,}000-line scientific
standard library, both written entirely in \sounio itself
...
soundness---is fully mechanized in \lean with 731 definitions and
