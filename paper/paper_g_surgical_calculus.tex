...
\begin{table}[h]
\centering
\caption{The six surgical types, their required effect sets, error codes
...
\begin{table}[h]
\centering
\caption{Model composition (G8).  Two teams, one with readout in the
...
\begin{table}[h]
\centering
\caption{Audit (G9).  The ZD-exact unlearn op emits a Lean term whose
...
\begin{table}[h]
\centering
\caption{Revive (G10).  Armed at tick $100$ with window $5$, edit
