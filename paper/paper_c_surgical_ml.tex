...
\begin{table}[h]
\centering
\caption{Machine unlearning residual L2 vs target (bob-only) weight.}
...
\begin{table}[h]
\centering
\caption{Max ripple across safe and unsafe facts under two edit strategies.}
\label{tab:editing}
\begin{tabular}{@{}lcc@{}}
\toprule
...
\begin{table}[h]
\centering
\caption{Accuracy after capability-removal methods.  Ideal: safe-acc $\to
