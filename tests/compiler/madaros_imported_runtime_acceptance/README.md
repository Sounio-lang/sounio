...
advances from the declared, tracked Madaros seed twice in the clean checkout.
It records the seed, both output hashes, and requires the two output ELFs to
match before running this fixture pair.
