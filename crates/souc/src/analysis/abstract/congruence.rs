...
impl Congruence {
    ...
    pub fn is_odd(&self) -> bool {
        match self {
            Congruence::Cong { modulus, remainder } if *modulus % 2 == 0 => *remainder % 2 == 1,
            Congruence::Cong {
                modulus: 0,
                remainder,
            } => *remainder % 2 == 1,
    ...
    pub fn shl(&self, bits: u32) -> Self {
        match self {
            ...
            Congruence::Cong { modulus, remainder } => {
                let shift = 1u64 << bits;
                Congruence::new(
                    modulus.saturating_mul(shift),
                    remainder.saturating_mul(shift),
                )
            }
        }
    }
            ...
            (
                ...
                if *m1 == 0 && *m2 == 0 {
                    ...
                    if diff % g != 0 {
                        ...
                        let r = (*r1 as i64
                            + (*m1 as i64) * x * ((*r2 as i64 - *r1 as i64) / (g as i64)))
