...
impl TapeOp {
    ...
    pub fn is_differentiable(&self) -> bool {
        !matches!(
            self,
            TapeOp::Const | TapeOp::Load | TapeOp::Store | TapeOp::Copy | TapeOp::Nop
        )
    }
...
impl GpuTape {
    ...
    pub fn record_const(&mut self, result: ValueId, value: f64, ty: GpuType) -> u32 {
        ...
        let entry =
            TapeEntry::new(TapeOp::Const, result_idx, ty).with_extra(TapeExtra::ConstFloat(value));
