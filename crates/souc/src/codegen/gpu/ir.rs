...
pub enum SparseQuatFormat {
    ...
    QuatBCSR { block_m: u32, block_n: u32 },
...
/// GPU operations
#[allow(non_snake_case)] // Domain-specific: dW = weight gradient, kH/kW = kernel height/width
#[derive(Debug, Clone)]
pub enum GpuOp {
    // === Constants ===
