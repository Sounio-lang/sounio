...
mod tests {
    ...
    fn test_gadt_unit_variant() {
        ...
        assert!(
            result.is_ok(),
            "Failed to parse unit GADT variant: {:?}",
            result
        );
    ...
    fn test_gadt_tuple_variant() {
        ...
        assert!(
            result.is_ok(),
            "Failed to parse tuple GADT variant: {:?}",
            result
        );
    ...
    fn test_gadt_multiple_variants() {
        ...
        assert!(
            result.is_ok(),
            "Failed to parse multi-variant GADT: {:?}",
            result
        );
    ...
    fn test_mixed_adt_and_gadt_variants() {
        ...
        assert!(
            result.is_ok(),
            "Failed to parse mixed ADT/GADT: {:?}",
            result
        );
    ...
    fn test_regular_struct_variant() {
        ...
        assert!(
            result.is_ok(),
            "Failed to parse struct variant ADT: {:?}",
            result
        );
    ...
    fn test_gadt_struct_variant() {
        ...
        assert!(
            result.is_ok(),
            "Failed to parse struct GADT variant: {:?}",
            result
        );
    ...
    fn test_gadt_with_const_generic() {
        ...
        assert!(
            result.is_ok(),
            "Failed to parse const generic GADT: {:?}",
            result
        );
    }
    ...
    fn test_gadt_type_equality() {
        ...
        assert!(
            result.is_ok(),
            "Failed to parse type equality GADT: {:?}",
            result
        );
    }
    ...
    fn test_gadt_trailing_comma() {
        ...
        assert!(
            result.is_ok(),
            "Failed to parse GADT with trailing comma: {:?}",
            result
        );
    }
}
