...
#[inline(never)]
pub fn quat_mul_i8_int32(q1: QuatI8, scale1: f32, q2: QuatI8, scale2: f32) -> (QuatI8, f32) {
...
pub extern "C" fn sounio_quat_linear_i8_fwd(
    ...
    let out_ptr = unsafe { std::slice::from_raw_parts_mut(out, (num_out * 4) as usize as usize) };
...
#[unsafe(no_mangle)]
pub extern "C" fn sounio_quat_dequantize_i8_to_f32(quat: *const i8, scale: f32, out: *mut f32) {
    let quat_slice = unsafe { std::slice::from_raw_parts(quat, 4) };
...
#[unsafe(no_mangle)]
pub extern "C" fn sounio_quat_batch_norm_i8(quats: *const i8, scales: *const f32, n: i32) -> f32 {
