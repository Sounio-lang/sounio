...
pub enum MemoryOp {
    ...
    /// Extract field from struct pointer (combined GEP + Load)
    /// This is a convenience op that computes ptr + field_offset and loads
    ExtractField {
        ptr: ValueId,
        /// Byte offset of the field from struct base
        field_offset: usize,
        /// Type of the field being extracted
        field_ty: SirType,
    },
}
    ...
    pub fn operands(&self) -> Vec<ValueId> {
        match self {
            ...
            SirInst::Memory(mem) => match mem {
                ...
                MemoryOp::ExtractField { ptr, .. } => vec![*ptr],
            },
