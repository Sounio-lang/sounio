...
static BFO_TERMS: &[PrimitiveTerm<BfoClass>] = &[
    ...
    // Remaining BFO 2020 terms
    PrimitiveTerm {
        variant: BfoClass::ObjectAggregate,
        id: "BFO:0000024",
        label: "object aggregate",
        definition: "A material entity that is a mereological sum of separate object entities and possesses non-connected boundaries.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000024",
    },
    PrimitiveTerm {
        variant: BfoClass::FiatObjectPart,
        id: "BFO:0000024",
        label: "fiat object part",
        definition: "A material entity that is a proper continuant part of an object but is not demarcated by any physical discontinuities.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000024",
    },
    PrimitiveTerm {
        variant: BfoClass::ImmaterialEntity,
        id: "BFO:0000141",
        label: "immaterial entity",
        definition: "An independent continuant that has no material entities as parts.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000141",
    },
    PrimitiveTerm {
        variant: BfoClass::Site,
        id: "BFO:0000029",
        label: "site",
        definition: "A three-dimensional immaterial entity that is (partially or wholly) bounded by a material entity or a three-dimensional immaterial entity.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000029",
    },
    PrimitiveTerm {
        variant: BfoClass::SpatialRegion,
        id: "BFO:0000006",
        label: "spatial region",
        definition: "A continuant entity that is a relational entity that is a part of space.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000006",
    },
    PrimitiveTerm {
        variant: BfoClass::OneDimensionalSpatialRegion,
        id: "BFO:0000026",
        label: "one-dimensional spatial region",
        definition: "A spatial region that has one dimension.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000026",
    },
    PrimitiveTerm {
        variant: BfoClass::TwoDimensionalSpatialRegion,
        id: "BFO:0000009",
        label: "two-dimensional spatial region",
        definition: "A spatial region that has two dimensions.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000009",
    },
    PrimitiveTerm {
        variant: BfoClass::ThreeDimensionalSpatialRegion,
        id: "BFO:0000028",
        label: "three-dimensional spatial region",
        definition: "A spatial region that has three dimensions.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000028",
    },
    PrimitiveTerm {
        variant: BfoClass::ZeroDimensionalSpatialRegion,
        id: "BFO:0000018",
        label: "zero-dimensional spatial region",
        definition: "A spatial region that has no dimensions.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000018",
    },
    PrimitiveTerm {
        variant: BfoClass::ContinuantFiatBoundary,
        id: "BFO:0000140",
        label: "continuant fiat boundary",
        definition: "A fiat boundary that is a continuant and that is of zero, one or two dimensions.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000140",
    },
    PrimitiveTerm {
        variant: BfoClass::OneDimensionalContinuantFiatBoundary,
        id: "BFO:0000142",
        label: "one-dimensional continuant fiat boundary",
        definition: "A continuant fiat boundary that is one-dimensional.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000142",
    },
    PrimitiveTerm {
        variant: BfoClass::TwoDimensionalContinuantFiatBoundary,
        id: "BFO:0000146",
        label: "two-dimensional continuant fiat boundary",
        definition: "A continuant fiat boundary that is two-dimensional.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000146",
    },
    PrimitiveTerm {
        variant: BfoClass::ZeroDimensionalContinuantFiatBoundary,
        id: "BFO:0000147",
        label: "zero-dimensional continuant fiat boundary",
        definition: "A continuant fiat boundary that is zero-dimensional.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000147",
    },
    PrimitiveTerm {
        variant: BfoClass::SpecificallyDependentContinuant,
        id: "BFO:0000020",
    ...
    PrimitiveTerm {
        variant: BfoClass::RealizableEntity,
        id: "BFO:0000017",
    ...
    PrimitiveTerm {
        variant: BfoClass::Disposition,
        id: "BFO:0000016",
        label: "disposition",
        definition: "A realizable entity that essentially causes a specific process or transformation in the object in which it inheres, under specific circumstances and in conjunction with the laws of nature.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000016",
    },
    PrimitiveTerm {
        variant: BfoClass::GenericallyDependentContinuant,
        id: "BFO:0000031",
        label: "generically dependent continuant",
        definition: "A continuant that is dependent on one or more other independent continuants but can migrate from one to another.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000031",
    },
    PrimitiveTerm {
        variant: BfoClass::ProcessBoundary,
        id: "BFO:0000035",
        label: "process boundary",
        definition: "A temporal boundary of a process is an occurrent entity that has no proper temporal parts.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000035",
    },
    PrimitiveTerm {
        variant: BfoClass::SpatiotemporalRegion,
        id: "BFO:0000011",
    ...
    PrimitiveTerm {
        variant: BfoClass::TemporalRegion,
        id: "BFO:0000008",
        label: "temporal region",
        definition: "An occurrent entity that is part of time.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000008",
    },
    PrimitiveTerm {
        variant: BfoClass::ZeroDimensionalTemporalRegion,
        id: "BFO:0000148",
        label: "zero-dimensional temporal region",
        definition: "A temporal region that is a temporal instant.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000148",
    },
    PrimitiveTerm {
        variant: BfoClass::OneDimensionalTemporalRegion,
        id: "BFO:0000038",
        label: "one-dimensional temporal region",
        definition: "A temporal region that has a non-zero duration.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000038",
    },
    PrimitiveTerm {
        variant: BfoClass::TemporalInterval,
        id: "BFO:0000202",
        label: "temporal interval",
        definition: "A one-dimensional temporal region that is a maximal connected temporal region.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000202",
    },
    PrimitiveTerm {
        variant: BfoClass::TemporalInstant,
        id: "BFO:0000203",
        label: "temporal instant",
        definition: "A zero-dimensional temporal region that is a single point in time.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000203",
    },
    PrimitiveTerm {
        variant: BfoClass::History,
        id: "BFO:0000182",
        label: "history",
        definition: "A process that is the sum of all processes taking place in the spatiotemporal region occupied by the material entity.",
        iri: "http://purl.obolibrary.org/obo/BFO_0000182",
    },
    PrimitiveTerm {
        variant: BfoClass::ProcessProfile,
        id: "BFO:0000144",
        label: "process profile",
        definition: "A processual entity that is a part of a process.",
