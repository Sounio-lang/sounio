...
use sounio::sir::{
    ABComparisonResult, AllocationMetrics, AttentionConfig, EpistemicMetadata,
...
fn main() {
    ...
    let scenarios = vec![
        (
            "Uniform confidence (0.5)",
            create_scenario(100, 0.5, 0.5, false),
        ),
        (
            "High confidence (0.9)",
            create_scenario(100, 0.9, 0.1, false),
        ),
        (
            "Low confidence (0.1)",
            create_scenario(100, 0.1, 0.9, false),
        ),
