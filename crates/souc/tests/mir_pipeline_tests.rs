...
mod tests {
    ...
    fn test_mir_construction_basic() {
        ...
        match &entry_block.instructions[0] {
            MirInstruction::Binary {
                ...
                assert_eq!(*result, ValueId(2)); // first fresh_value() after 2 params
                assert_eq!(*op, MirBinaryOp::Add);
                assert_eq!(*left, ValueId(0)); // param 0
                assert_eq!(*right, ValueId(1)); // param 1
    ...
    fn test_loop_analysis_simple_loop() {
        ...
        // Branch from entry to loop header
        ...
        // The loop should at least include the header block
        assert!(detected_loop.contains_block(loop_header));
        // Note: Full loop body detection may depend on the analysis implementation
    ...
    fn test_strength_reduction() {
        ...
        // Note: The optimization may or may not modify the function depending on implementation
    ...
    fn test_function_inlining() {
        ...
        // Note: Inlining behavior depends on implementation and heuristics
