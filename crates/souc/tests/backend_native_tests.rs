...
use sounio::backend::native::{
    NativeBackend,
    alloc::{EpistemicAllocator, LiveInterval, RegClass, VirtReg},
    metrics::{
        CycleModel, OpClass, Operand, PowerModel, SirBlock, SirInstruction, SirMetricsEstimator,
    },
...
fn test_register_allocator() {
    ...
    for i in 0..5 {
        let mut interval =
            LiveInterval::new(VirtReg(i), RegClass::GeneralPurpose, (i * 10) as usize);
