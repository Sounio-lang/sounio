...
export default function MascotHeroWebGL() {
  ...
  return (
    <div class="relative w-full h-screen overflow-hidden bg-[#020617]">
      ...
      <div class="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 opacity-50 hover:opacity-100 transition-opacity duration-300 pointer-events-auto cursor-pointer" onClick={() => window.scrollTo({ top: window.innerHeight, behavior: 'smooth' })}>
        <span class="font-mono text-xs text-white tracking-[0.2em] uppercase">Scroll to explore</span>
        <svg class="w-5 h-5 text-white animate-bounce" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
