...
const copy = {
  en: {
    eyebrow: 'THE PARTICLE LOOM / EXACT OCTONION WITNESS',
  ...
  pt: {
    eyebrow: 'O TEAR DE PARTÍCULAS / WITNESS OCTONIONAL EXATO',
...
const repo = 'https://github.com/Sounio-lang/sounio/blob/f051ffbe33bd16aeddc47d0627a0fa5b08775057';
        ...
        <div className="pl-loom" aria-live="polite">
          ...
          <aside className="pl-spectrum" id="pl-spectrum" role="tabpanel" aria-labelledby="pl-spectrum-tab">
            ...
            <div className="pl-tracks">
              {tracks.map((track) => (
                <div className="pl-track" key={track.n}>
            ...
            <div className="pl-spectrum-note"><span>{d.multiplicity}</span><strong>1 · 3 · 3 · 1</strong><code>{d.focusSpectrum}</code></div>
          </aside>
        </div>
