  ...
  return (
    <section className="relative flex min-h-[100vh] w-full items-center justify-center overflow-hidden bg-[#020617]">
      ...
      <div className="relative z-10 container flex flex-col items-center justify-center px-4 py-24 text-center">
        ...
        >
          <span className="rounded-full border border-white/10 bg-white/5 px-4 py-1.5 font-mono text-xs uppercase tracking-[0.2em] text-[var(--color-accent-blue-soft)] backdrop-blur-md">
        ...
        >
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-[var(--color-accent-blue)] to-[var(--color-accent-blue)] opacity-0 transition-opacity duration-500 group-hover:opacity-20" />
