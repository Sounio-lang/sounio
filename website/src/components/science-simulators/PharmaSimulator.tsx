  ...
  const controls = (
    <>
      ...
      <div className="flex flex-col gap-2 mt-4">
        ...
        <div className="flex items-center gap-2 text-sm text-[var(--color-text-secondary)]">
          <div className="w-3 h-3 bg-[var(--color-accent-blue)] opacity-20 border border-[var(--color-accent-blue)]"></div>
  ...
  const visualization = (
    <div className="w-full h-full min-h-[300px] flex items-center justify-center">
      <svg viewBox="0 0 500 300" className="w-full h-full overflow-visible">
        ...
        <path d={areaPath} fill="var(--color-accent-blue)" opacity="0.15" />
        <path d={areaPath} fill="none" stroke="var(--color-accent-blue)" strokeWidth="1" opacity="0.3" strokeDasharray="4 2" />
        
        {/* Main Curve */}
        <path d={curvePath} fill="none" stroke="var(--color-accent-blue)" strokeWidth="3" />
