    ...
    <div className="relative w-full max-w-2xl mx-auto font-sans">
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          <input
            type="text"
            className="w-full bg-[var(--color-surface-secondary)] border border-[var(--glass-border)] text-[var(--color-text-primary)] rounded-lg px-4 py-3 focus:outline-none focus:border-[var(--color-accent-steel)] focus:ring-1 focus:ring-[var(--color-accent-steel)] transition-all"
            ...
            <ul className="max-h-80 overflow-y-auto p-2">
              {results.map((term) => (
                <li key={term.id}>
                  ...
                  >
                    <div className="mt-0.5 w-6 h-6 rounded bg-[var(--color-accent-steel)]/10 text-[var(--color-accent-steel)] flex items-center justify-center shrink-0">
      ...
      {selectedTerm && (
        <div className="mt-4 p-5 rounded-xl border border-[var(--color-accent-steel)]/30 bg-[var(--color-accent-steel)]/5 backdrop-blur-sm animate-in fade-in slide-in-from-top-2">
          <div className="flex justify-between items-start mb-3">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xs font-mono px-2 py-0.5 rounded bg-[var(--color-accent-steel)]/20 text-[var(--color-accent-steel)] border border-[var(--color-accent-steel)]/30">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              ...
              <div className="text-xs px-2 py-1 rounded bg-[var(--color-accent-steel)]/10 text-[var(--color-accent-steel)] border border-[var(--color-accent-steel)]/20 font-medium">
                {selectedTerm.name}
              </div>
            </div>
          </div>
