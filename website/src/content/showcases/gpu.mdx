...
# Emit the predefined vec_add PTX template
...
- PTX templates: `kretikos emit-ptx` (in-tree self-hosted emitter); broader PTX emission through `build --backend gpu` (checked GPU artifact)
