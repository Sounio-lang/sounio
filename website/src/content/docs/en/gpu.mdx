...
- The `kretikos bundle` command writes a machine-readable `sounio.kretikos.bundle.v1` manifest with artifact hashes, structural checks, and explicit non-claims.
